...
export class UserController {
	...
	@HttpCode(200)
	@Auth()
	async updateProfile(@User('_id') _id: string, @Body() data: UserDto) {
	...
	async toggleFavorite(
		@Body('passId', IdValidationPipe) passId: Types.ObjectId,
		@User() user: UserModel
	) {
		return this.userService.toggleFavorite(passId, user)
	}
